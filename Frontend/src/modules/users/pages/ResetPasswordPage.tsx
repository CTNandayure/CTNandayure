...
import { validatePassword, validatePasswordConfirmation, passwordChecks } from '../utils/validators'
          ...
          <div className="relative flex h-full flex-col justify-between p-8 text-white md:p-12 lg:p-16">
            ...
            <div className="max-w-md pb-4 lg:pb-8">
              ...
              <p className="mt-5 text-base leading-7 text-white/85">
                Ingresa tu nueva contraseña a continuación. El enlace expirará en 24 horas.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="w-full max-w-md">
            {done ? (
              ...
              <form onSubmit={submit} className="space-y-5" noValidate>
                ...
                <div>
                  <label htmlFor="reset-password" className="mb-1.5 block text-sm font-semibold text-brand-navy">
                    Nueva contraseña
                  </label>
                ...
                <div>
                  <label htmlFor="reset-confirm" className="mb-1.5 block text-sm font-semibold text-brand-navy">
