...
export type TableActionVariant = 'view' | 'edit' | 'activate' | 'deactivate' | 'publish' | 'unpublish'
...
const variants: Record<TableActionVariant, string> = {
  ...
  publish: `${base} bg-brand-green/10 text-brand-green-strong hover:bg-brand-green/20`,
  unpublish: `${base} bg-brand-yellow/20 text-brand-navy hover:bg-brand-yellow/30`,
}
...
function CloudUpIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-3.5 w-3.5" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 18a4.5 4.5 0 01-.5-8.975A5.25 5.25 0 0117.5 8.25c.037 0 .075 0 .112.002A4.5 4.5 0 0117 18H7.5z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25v-6m0 0l-2.25 2.25M12 8.25l2.25 2.25" />
    </svg>
  )
}
